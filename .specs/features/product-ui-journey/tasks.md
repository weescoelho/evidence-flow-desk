...
| [x] 1.3 | Ecrãs 06/07 + itens globais Templates/Screenshots: vista ao clicar na sidebar | UI-R06 | **07** `EvidenceAppSettingsView`; **06** `Documentos`; **Templates** = `EvidenceTemplatesLibraryView`; **Screenshots** = stub dedicado |
...
| 2026-05-12 | **1.3 (completo)** | **Templates**: `EvidenceTemplatesLibraryView` (preset activo + CRUD via `EvidenceTemplatesManagePanel`); **Screenshots**: `EvidenceScreenshotsPlaceholderView`; entradas da sidebar activas (`App.tsx`). Histórico = Documentos; Config = settings. |
...
| 2026-05-12 | **Checklist formal** | Tabelas P1–P2: todas as tarefas marcadas `[x]` após verificação cruzada com código. |
