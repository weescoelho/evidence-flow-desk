...
**Depende de:** [technical-summary-mvp](../technical-summary-mvp/spec.md), [git-commits-and-changes](../git-commits-and-changes/spec.md).
...
Quando o escopo Git é carregado com sucesso, o utilizador vê **pré-visualização** do documento final que reflete o estado actual (atualiza ao mudar base/compare/dados).
...
- Syntax highlight em blocos de código, imagens anexas (RF-012).
